...
export const Logos = () => {
  return (
    <div style={{ background: '#F4F5F7' }} className='p-20'>
      {RenderCompanyLogos()}
...
const RenderCompanyLogos = () => {
  return (
    ...
    <div style={{ display: 'flex' }}>
      ...
      <div>
        <div>
          <img src={LogoDarkModeFalse} alt='logo'></img>
        </div>
        <div>
          <img src={LogoDarkModeTrue} alt='logo'></img>
        </div>
      </div>
      <div></div>
    </div>
    ...
    <div style={{ display: 'flex' }}>
      <div style={{ display: 'flex', width: '50%' }}>
        <div className='mx-20 col-2'>
          <div className='my-20'>
            <div>
              <img src={LayerLogotypeTrueColorDefault} alt='logo'></img>
              <img
            ...
            <div>
              <img src={LayerLogotypeTrueColorWhite} alt='logo'></img>
              <img
          ...
          <div className='my-20'>
            <div>
              <img src={SisyphusLogotypeTrueColorDefault} alt='logo'></img>
              <img
            ...
            <div>
              <img src={SisyphusLogotypeTrueColorWhite} alt='logo'></img>
              <img
          ...
          <div className='my-20'>
            <div>
              <img src={CircoolesLogotypeTrueColorDefault} alt='logo'></img>
              <img
            ...
            <div>
              <img src={CircoolesLogotypeTrueColorWhite} alt='logo'></img>
              <img
          ...
          <div className='my-20'>
            <div>
              <img src={CatalogLogotypeTrueColorDefault} alt='logo'></img>
              <img
            ...
            <div>
              <img src={CatalogLogotypeTrueColorWhite} alt='logo'></img>
              <img
        ...
        <div className='mx-2 col-2'>
          <div className='my-20'>
            <div>
              <img src={QuotientLogotypeTrueColorDefault} alt='logo'></img>
              <img
            ...
            <div>
              <img src={QuotientLogotypeTrueColorWhite} alt='logo'></img>
              <img
          ...
          <div className='my-20'>
            <div>
              <img src={HourGlassLogotypeTrueColorDefault} alt='logo'></img>
              <img
            ...
            <div>
              <img src={HourGlassLogotypeTrueColorWhite} alt='logo'></img>
              <img
          ...
          <div className='my-20'>
            <div>
              <img src={CommandLogotypeTrueColorDefault} alt='logo'></img>
              <img
            ...
            <div>
              <img src={CommandLogotypeTrueColorWhite} alt='logo'></img>
              <img
      ...
      <div>
        <div style={{ display: 'flex', width: '50%' }}>
          <div>
              <div >
                <div style={{ display: 'flex' }}>
                  <img src={LayerLogoImage} alt='logo' className='m-20'></img>
                  <img src={LayerImage} alt='logo' className='mx-20'></img>
                </div>
                <div className='ml-20 text-style'>Layer</div>
              </div>
              <div>
                <div>
                  <img src={SisyphusLogoImage} alt='logo' className='m-20'></img>
                  <img src={SisyphusImage} alt='logo' className='m-20'></img>
                </div>
                <div className='ml-20 text-style'>Sisyphus</div>
              </div>
              <div>
                <div>
                  <img src={CircoolesLogoImage} alt='logo' className='m-20'></img>
                  <img src={CircoolesImage} alt='logo' className='m-20'></img>
                </div>
                <div className='ml-20 text-style'>Circooles</div>
              </div>
              <div>
                <div>
                  <img src={CatalogLogoImage} alt='logo' className='m-20'></img>
                  <img src={CatalogImage} alt='logo' className='m-20'></img>
                </div>
                <div className='ml-20 text-style'>Catalog</div>
              </div>
              <div>
                <div>
                  <img src={QuotientLogoImage} alt='logo' className='m-20'></img>
                  <img src={QuotientImage} alt='logo' className='m-20'></img>
                </div>
                <div className='ml-20 text-style'>
                  Quotient
                </div>
              </div>
              <div>
                <div>
                  <img src={HourGlassLogoImage} alt='logo' className='m-20'></img>
                  <img src={HourGlassImage} alt='logo' className='m-20'></img>
                </div>
                <div className='ml-20 text-style'>
                  HourGlass
                </div>
              ...
              <div>
                <div>
                  <img src={CommandLogoImage} alt='logo' className='m-20'></img>
                  <img src={CommandImage} alt='logo' className='m-20'></img>
                </div>
                <div className='ml-20 text-style'>
                  Command+R
                </div>
              ...
              <div>
                <div>
                  <img src={UntitleUILogoImage} alt='logo' className='m-20'></img>
                  <img src={UntitleUIImage} alt='logo' className='m-20'></img>
                </div>
                <div className='ml-20 text-style'>
                  Untitle UI
                </div>
  ...
  return(
    <div>
        ...
        <div style={{ display: 'flex' }}>
          <div >
            <div className='m-20'>
              <img src={TheWashingtonPost} alt='logo'></img>
            </div>
            <div className='m-20'>
              <img src={TechCruch} alt='logo'></img>
            </div>
            <div className='m-20'>
              <img src={TheNewyorkTimes} alt='logo'></img>
            </div>
            <div className='m-20'>
              <img src={Forbes} alt='logo'></img>
            </div>
            <div className='m-20'>
              <img src={Gizmodo} alt='logo'></img>
            </div>
            <div className='m-20'>
              <img src={FastCompany} alt='logo'></img>
            </div>
          </div>
          <div>
            <div className='m-20'>
              <img src={BloomBerg} alt='logo'></img>
            </div>
            <div className='m-20'>
              <img src={Wired} alt='logo'></img>
            </div>
            <div className='m-20'>
              <img src={BusinessInsider} alt='logo'></img>
            </div>
            <div className='m-20'>
              <img src={TheGuardian} alt='logo'></img>
            </div>
            <div className='m-20'>
              <img src={Engadget} alt='logo'></img>
            </div>
          </div>
        </div>
      </div>
